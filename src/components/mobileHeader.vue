...
<template>
  <header class="header">
    <nav class="header__nav">
      <ul class="header__item-groups">

        <li class="header__item-group">
          <button class="header__item-closeBtn closeBtn">
        ...
        <li class="header__item-group">
          <h4 class="header__item__group-title" v-if="props.title">{{ props.title }}</h4>
        </li>
        <li class="header__item-group">
