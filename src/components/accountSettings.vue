...
<template>
  <div class="accountSettings popup">
    ...
    <div class="accountSettings__preferences">
      ...
      <ul>
        <li class="account__settings__preferences-privacy">
          <toggle-list title="Privacy">
        ...
        <li class="account__settings__preferences-notification">
          <toggle-list title="Notification">
