    ...
    <div class="conv__send" v-if="activeChat">
      <form class="conv__send__form" >
        ...
        <div class="conv__send__form-buttons">
          <button type="button" class="conv__send__form-buttons-button emoji-btn">
          ...
          <button type="button" class="conv__send__form-buttons-buttons-button microphone-btn">
            <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <label for="conv__send-file" class="conv__send__form-buttons-buttons-button clip-btn">
          ...
          <input style="display: none" type="file" id="conv__send-file" value="" @change="onFileSelected">
        </div>

        <button class="conv__send__form-submit" @click.prevent="onSubmitClick">
